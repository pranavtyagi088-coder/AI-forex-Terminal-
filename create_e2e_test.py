...
e2e_content = '''import { test, expect } from '@playwright/test';
...
e2e_file = ROOT / "frontend/e2e/broker-bridge.spec.ts"
e2e_file.parent.mkdir(parents=True, exist_ok=True)
e2e_file.write_text(e2e_content, encoding="utf-8")
print("[SUCCESS] frontend/e2e/broker-bridge.spec.ts created!")
